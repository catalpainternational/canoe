...
registerRoute(
    new RegExp(`${BACKEND_BASE_URL}/token-auth/`),
    new NetworkOnly()
);
...
registerRoute(
    new RegExp(`${BACKEND_BASE_URL}/api/v2/page_preview`),
    new NetworkOnly()
);

registerRoute(
    new RegExp(`${BACKEND_BASE_URL}/progress/completions`),
    new NetworkOnly()
);
